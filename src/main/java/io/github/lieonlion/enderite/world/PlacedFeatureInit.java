...
public class PlacedFeatureInit {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, ENDERITE_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ConfiguredFeatureInit.ENDERITE_ORE_KEY),
                OrePlacementInit.modifiersWithCount(2,
                        HeightRangePlacementModifier.trapezoid(YOffset.fixed(10), YOffset.fixed(20))));
    }

    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(Enderite.MODID, name));
    }
