...
public enum ArmorMaterialsInit implements ArmorMaterial {
    //ENDERITE("enderite", 49, new int[]{4, 7, 9, 4}, 25,
    //        SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0f, 0.1f, () -> Ingredient.ofItems(ItemInit.ENDERITE_INGOT));

    ENDERITE("enderite", 49, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
    ...
    private ArmorMaterialsInit(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredientSupplier) {
        this.name = name;
